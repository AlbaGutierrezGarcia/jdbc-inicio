...
public class Jardineria {
        ...
        // Utilizamos el criterio de "responsabilidad única" del código y creamos este metodo que se ocupa de preguntar
   ...
   /* private static void leerYModificarCampos(Scanner scanner, Oficina oficina, OficinaRepo repo) throws IllegalAccessException, SQLException {
        ...
        while (seguir) {
            ...
            // Si el campo es mayor que la última opción, salimos del metodo
